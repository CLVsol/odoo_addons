...
class clv_medicament_prescription_category(osv.osv):
    _name = 'clv_medicament_prescription.category'
    ...
    _columns = {
        ...
        'parent_id': fields.many2one('clv_medicament_prescription.category', 'Parent Category', select=True, ondelete='restrict'),
        ...
        'child_ids': fields.one2many('clv_medicament_prescription.category', 'parent_id', 'Child Categories'),
...
class clv_medicament_prescription(osv.osv):
    ...
    _columns = {
        'category_ids': fields.many2many('clv_medicament_prescription.category', 
                                         'clv_medicament_prescription_category_rel', 
                                         'medicament_id', 
                                         'category_id', 
                                         'Categories'),
