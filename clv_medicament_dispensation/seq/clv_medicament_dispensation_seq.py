...
class clv_medicament_dispensation(osv.osv):
    ...
    def create(self, cr, uid, vals, context=None):
        ...
        if not 'name' in vals or ('name' in vals and vals['name'] == '/'):
            code_seq = self.pool.get('ir.sequence').get(cr, uid, 'clv_medicament_dispensation.code')
            vals['name'] = format_code(code_seq)
        return super(clv_medicament_dispensation, self).create(cr, uid, vals, context)
    ...
    def copy(self, cr, uid, id, default={}, context=None):
        ...
        default.update({'name': '/',})
        return super(clv_medicament_dispensation, self).copy(cr, uid, id, default, context)
