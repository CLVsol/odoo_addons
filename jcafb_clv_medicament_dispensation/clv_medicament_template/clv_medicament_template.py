...
class clv_medicament_template(osv.osv):
    ...
    _columns = {
        ...
        'question_02_01': fields.selection([('a', 'a) oral'),
                                            ('b', 'b) inalatória'),
                                            ('c', 'c) tópica'),
                                            ('d', 'd) oftálmica'),
                                            ('e', 'e) otológica'),
                                            ...
                                            ('h', 'h) intravenoso'),
                                            ('i', 'i) outra'),
                                            ], string='Via de Administração',select=True, sort=False),
        ...
        'question_02_03': fields.selection([('g', 'g'),
                                            ('mg', 'mg'),
                                            ('mcg', 'mcg'),
                                            ('ml', 'ml'),
                                            ('comp', 'comprimido'),
                                            ('ui', 'UI'),
                                            ], string='Unidade da dose',select=True, sort=False),
        ...
        #                                  help='oral/inalatória/tópica/oftálmica/otológica/intramuscular/subcutânea/intravenoso'),
        'question_06_01': fields.selection([('a', 'a) oral'),
                                            ('b', 'b) inalatória'),
                                            ('c', 'c) tópica'),
                                            ('d', 'd) oftálmica'),
                                            ('e', 'e) otológica'),
        ...
        #                              help='Unit of measure for the medicament to be taken'),
        'question_06_03': fields.selection([('g', 'g'),
                                            ('mg', 'mg'),
                                            ('mcg', 'mcg'),
                                            ('ml', 'ml'),
                                            ('comp', 'comprimido'),
