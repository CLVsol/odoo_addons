...
class clv_medicament_catalog_category(models.Model):
    _name = 'clv_medicament_catalog.category'

    name = fields.Char('Category', required=True, size=64, translate=True)
    parent_id = fields.Many2one('clv_medicament_catalog.category', 'Parent Category', select=True, ondelete='restrict')
    ...
    child_ids = fields.One2many('clv_medicament_catalog.category', 'parent_id', 'Child Categories')
    ...
    medicament_catalog_ids = fields.Many2many('clv_medicament_catalog', 
                                 'clv_medicament_catalog_category_rel', 
                                 'category_id', 
...
class clv_medicament_catalog(models.Model):
    ...
    category_id = fields.Many2one('clv_medicament_catalog.category', 'Category')
