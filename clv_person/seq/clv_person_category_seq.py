...
class clv_person_category(osv.osv):
    ...
    def create(self, cr, uid, vals, context=None):
        ...
        return super(clv_person_category, self).create(cr, uid, vals, context)
    ...
    def copy(self, cr, uid, id, default={}, context=None):
        ...
        default.update({'code': '/',})
        return super(clv_person_category, self).copy(cr, uid, id, default, context)
