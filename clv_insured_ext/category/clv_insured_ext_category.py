...
class clv_insured_ext_category(models.Model):
    _name = 'clv_insured_ext.category'

    name = fields.Char('Category', required=True, size=64, translate=True)
    parent_id = fields.Many2one('clv_insured_ext.category', 'Parent Category', select=True, ondelete='restrict')
    ...
    child_ids = fields.One2many('clv_insured_ext.category', 'parent_id', 'Child Categories')
...
class clv_insured_ext(models.Model):
    ...
    category_ids = fields.Many2many('clv_insured_ext.category', 
                                    'clv_insured_ext_category_rel', 
                                    'insured_ext_id', 
                                    'category_id', 
                                    'Categories')
