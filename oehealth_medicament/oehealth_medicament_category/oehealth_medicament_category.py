...
class oehealth_medicament_category(osv.osv):
    ...
    def name_get(self, cr, uid, ids, context=None):
        ...
        if context is None:
            context = {}
        if context.get('oehealth_medicament_category_display') == 'short':
    ...
    _description = 'OeHealth Medicament Categories'
    ...
    _columns = {
        ...
        'medicament_ids': fields.many2many('oehealth.medicament', id1='category_id', id2='medicament_id', string='Medicaments'),
    }
    _constraints = [
