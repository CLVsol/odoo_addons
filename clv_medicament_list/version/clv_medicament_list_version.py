...
class clv_medicament_list_version(models.Model):
    ...
    list_id = fields.Many2one('clv_medicament_list', 'Medicament List')
    name = fields.Char('List Version', required=True, size=64)
...
class clv_medicament_list(models.Model):
    ...
    current_version_id = fields.Many2one('clv_medicament_list.version', 'Current List Version', domain="[('list_id','=',id)]")
    medicament_list_version_ids = fields.One2many('clv_medicament_list.version',
                                                  'list_id',
