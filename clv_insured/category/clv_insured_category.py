...
class clv_insured_category(models.Model):
    _name = 'clv_insured.category'

    name = fields.Char('Category', required=True, size=64, translate=True)
    parent_id = fields.Many2one('clv_insured.category', 'Parent Category', select=True, ondelete='restrict')
    ...
    child_ids = fields.One2many('clv_insured.category', 'parent_id', 'Child Categories')
...
class clv_insured(models.Model):
    ...
    category_ids = fields.Many2many('clv_insured.category', 
                                    'clv_insured_category_rel', 
                                    'insured_id', 
                                    'category_id', 
                                    'Categories')
