...
class clv_family_category(models.Model):
    _name = 'clv_family.category'

    name = fields.Char('Category', required=True, size=64, translate=True)
    parent_id = fields.Many2one('clv_family.category', 'Parent Category', select=True, ondelete='restrict')
    ...
    child_ids = fields.One2many('clv_family.category', 'parent_id', 'Child Categories')
...
class clv_family(models.Model):
    ...
    category_ids = fields.Many2many('clv_family.category', 
                                    'clv_family_category_rel', 
                                    'family_id', 
                                    'category_id', 
                                    'Categories')
