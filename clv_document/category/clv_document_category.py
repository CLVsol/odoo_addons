...
class clv_document_category(osv.osv):
    ...
    _columns = {
        ...
        'parent_id': fields.many2one('clv_document.category', 'Parent Category', select=True, ondelete='restrict'),
        ...
        'child_ids': fields.one2many('clv_document.category', 'parent_id', 'Child Categories'),
...
class clv_document(osv.osv):
    ...
    _columns = {
        'category_ids': fields.many2many('clv_document.category', 
                                         'clv_document_category_rel', 
                                         'document_id', 
                                         'category_id', 
                                         'Categories'),
