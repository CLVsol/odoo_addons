...
class clv_insurance_category(models.Model):
    ...
    insurance_ids = fields.Many2many('clv_insurance', 
                                   'clv_insurance_category_rel', 
                                   'category_id', 
                                   'insurance_id', 
                                   'Insurances')
...
class clv_insurance(models.Model):
    ...
    category_ids = fields.Many2many('clv_insurance.category', 
                                    'clv_insurance_category_rel', 
                                    'insurance_id', 
                                    'category_id', 
                                    'Categories')
