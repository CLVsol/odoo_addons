...
class clv_file_category(models.Model):
    _name = 'clv_file.category'

    name = fields.Char('Category', required=True, size=64, translate=True)
    parent_id = fields.Many2one('clv_file.category', 'Parent Category', select=True, ondelete='restrict')
    ...
    child_ids = fields.One2many('clv_file.category', 'parent_id', 'Child Categories')
...
class clv_file(models.Model):
    ...
    category_ids = fields.Many2many('clv_file.category', 
                                    'clv_file_category_rel', 
                                    'file_id', 
                                    'category_id', 
                                    'Categories')
