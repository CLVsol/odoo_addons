...
class clv_professional_category(models.Model):
    _name = 'clv_professional.category'

    name = fields.Char('Category', required=True, size=64, translate=True)
    parent_id = fields.Many2one('clv_professional.category', 'Parent Category', select=True, ondelete='restrict')
    ...
    child_ids = fields.One2many('clv_professional.category', 'parent_id', 'Child Categories')
...
class clv_professional(models.Model):
    ...
    category_ids = fields.Many2many('clv_professional.category', 
                                    'clv_professional_category_rel', 
                                    'professional_id', 
                                    'category_id', 
                                    'Categories')
