...
class clv_community(osv.osv):
    ...
    def name_get(self, cr, uid, ids, context=None):
        ...
        if context.get('community_display') == 'short':
            return super(community, self).name_get(cr, uid, ids, context=context)
    ...
    _columns = {
        ...
        'parent_id': fields.many2one('clv_community', 'Parent Community', select=True, ondelete='restrict'),
    ...
    def onchange_address_id(self, cr, uid, ids, address, context=None):
        if address:
            ...
            return {'value': {'comm_phone': address.phone, 'mobile_phone': address.mobile, 'comm_email': address.email}}
        return {'value': {}}
