...
class clv_community(osv.osv):
    ...
    def create(self, cr, uid, vals, context=None):
        ...
        if not 'code' in vals or ('code' in vals and vals['code'] == '/'):
            code_seq = self.pool.get('ir.sequence').get(cr, uid, 'clv_community.code')
            vals['code'] = format_code(code_seq)
        return super(clv_community, self).create(cr, uid, vals, context)
    ...
    def copy(self, cr, uid, id, default={}, context=None):
        ...
        default.update({'code': '/',})
        return super(clv_community, self).copy(cr, uid, id, default, context)
