...
class clv_community_category(osv.osv):
    ...
    _columns = {
        ...
        'parent_id': fields.many2one('clv_community.category', 'Parent Category', select=True, ondelete='restrict'),
        ...
        'child_ids': fields.one2many('clv_community.category', 'parent_id', 'Child Categories'),
...
class clv_community(osv.osv):
    ...
    _columns = {
        'category_ids': fields.many2many('clv_community.category', 
                                         'clv_community_category_rel', 
                                         'community_id', 
                                         'category_id', 
                                         'Categories'),
