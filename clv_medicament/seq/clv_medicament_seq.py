...
class clv_medicament(osv.osv):
    ...
    _columns = {
        'code': fields.char('Medicament Code', size=64, select=1, required=False, readonly=False, default='/',
    ...
    def create(self, cr, uid, vals, context=None):
        ...
        if not 'code' in vals or ('code' in vals and vals['code'] == '/'):
            code_seq = self.pool.get('ir.sequence').get(cr, uid, 'clv_medicament.code')
    ...
    def copy(self, cr, uid, id, default={}, context=None):
        ...
        default.update({'code': '/',})
        return super(clv_medicament, self).copy(cr, uid, id, default, context)
