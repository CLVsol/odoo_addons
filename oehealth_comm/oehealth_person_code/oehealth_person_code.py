...
class oehealth_person_code(osv.osv):
    _description = 'Person Codes'
    _name = 'oehealth.person.code'
    ...
    _columns = {
        'name': fields.function(_compute_code_str, method=True, type='char', size=14, string='Person Code',),
    ...
    _sql_constraints = [('person_code_uniq', 'unique(code_number)', u'Duplicate Person Code!')]
