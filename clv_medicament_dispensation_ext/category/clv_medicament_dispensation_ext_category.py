...
class clv_medicament_dispensation_ext_category(models.Model):
    _name = 'clv_medicament_dispensation_ext.category'

    name = fields.Char('Category', required=True, size=64, translate=True)
    parent_id = fields.Many2one('clv_medicament_dispensation_ext.category', 'Parent Category', select=True, ondelete='restrict')
    ...
    child_ids = fields.One2many('clv_medicament_dispensation_ext.category', 'parent_id', 'Child Categories')
    ...
    medicament_dispensation_ext_ids = fields.Many2many('clv_medicament_dispensation_ext', 
                                       'clv_medicament_dispensation_ext_category_rel', 
                                       'category_id', 
...
class clv_medicament_dispensation_ext(models.Model):
    ...
    category_ids = fields.Many2many('clv_medicament_dispensation_ext.category', 
                                    'clv_medicament_dispensation_ext_category_rel', 
                                    'medicament_dispensation_ext_id', 
                                    'category_id', 
                                    'Categories')
