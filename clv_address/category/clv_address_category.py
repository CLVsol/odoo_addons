...
class clv_address_category(models.Model):
    _name = 'clv_address.category'

    name = fields.Char('Category', required=True, size=64, translate=True)
    parent_id = fields.Many2one('clv_address.category', 'Parent Category', select=True, ondelete='restrict')
    ...
    child_ids = fields.One2many('clv_address.category', 'parent_id', 'Child Categories')
...
class clv_address(models.Model):
    ...
    category_ids = fields.Many2many('clv_address.category', 
                                    'clv_address_category_rel', 
                                    'address_id', 
                                    'category_id', 
                                    'Categories')
